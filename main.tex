\documentclass[paper=A5,fontsize=12pt,openright,DIV=16,chapterprefix=on]{scrbook}      
\usepackage[UKenglish]{babel}
\usepackage[hyperfootnotes,colorlinks=true,citecolor=black,urlcolor=darkgray,linkcolor=black]{hyperref} % Clickable links
\usepackage{ebgaramond} % Classic style font
\usepackage[tracking=true,babel=true]{microtype}   % Better typography
