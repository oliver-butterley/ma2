...
\begin{example*}[Continuity problem in higher dimensions]
...
% Directional derivative is linear - we only need to care about direction of \(\vv\)
...
{Derivatives of vector fields (cont.)}
